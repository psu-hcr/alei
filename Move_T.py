...
def main():
	...
	try:
		...
		for i in range(30):
			...
			jointstate1 = [uniform(-pi/4, pi/4), uniform(-pi/4, pi/4), uniform(-pi/4, pi/4), uniform(-pi/4, pi/4), uniform(-pi/4, pi/4), uniform(-pi/4, pi/4), uniform(-pi/4, pi/4)]
		...
		path = '/home/zxl5344/test/src/alei/robotdata/MOVE_T.csv'
