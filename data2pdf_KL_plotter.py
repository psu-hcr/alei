...
data2 = genfromtxt('/home/zxl5344/test/src/alei/Gaussian_traj/CameraRecording_new2.csv',delimiter=",",dtype=float)
data2 = np.delete(data2,0,0)
x2 = data2[:, 1]
y2 = data2[:, 2]
z2 = data2[:, 3]

data3 = genfromtxt('/home/zxl5344/test/src/alei/Gaussian_traj/CameraRecording_new3.csv',delimiter=",",dtype=float)
